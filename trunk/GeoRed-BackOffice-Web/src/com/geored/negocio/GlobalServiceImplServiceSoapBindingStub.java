/**
 * GlobalServiceImplServiceSoapBindingStub.java
 *
...
public class GlobalServiceImplServiceSoapBindingStub extends org.apache.axis.client.Stub implements com.geored.negocio.GlobalServiceImpl {
    ...
    private static void _initOperationDesc1(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("obtenerListadoTematicas");
        oper.setReturnType(new javax.xml.namespace.QName("http://negocio.geored.com/", "tematicaDTO"));
        oper.setReturnClass(com.geored.negocio.TematicaDTO[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "return"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("obtenerListadoTiposAdministradores");
        oper.setReturnType(new javax.xml.namespace.QName("http://negocio.geored.com/", "tipoAdministradorDTO"));
        oper.setReturnClass(com.geored.negocio.TipoAdministradorDTO[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "return"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("obtenerListadoTiposNotificaciones");
    ...
    public GlobalServiceImplServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public GlobalServiceImplServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public GlobalServiceImplServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://negocio.geored.com/", "tipoAdministradorDTO");
            cachedSerQNames.add(qName);
            cls = com.geored.negocio.TipoAdministradorDTO.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://negocio.geored.com/", "tipoNotificacionDTO");
            cachedSerQNames.add(qName);
            cls = com.geored.negocio.TipoNotificacionDTO.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {methodName, methodParams});
  ...
  throw axisFaultException;
    ...
    public com.geored.negocio.TematicaDTO[] obtenerListadoTematicas() throws java.rmi.RemoteException, com.geored.negocio.DaoException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://negocio.geored.com/", "obtenerListadoTematicas"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (com.geored.negocio.TematicaDTO[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.geored.negocio.TematicaDTO[]) org.apache.axis.utils.JavaUtils.convert(_resp, com.geored.negocio.TematicaDTO[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
  ...
  throw axisFaultException;
    ...
    public com.geored.negocio.TipoAdministradorDTO[] obtenerListadoTiposAdministradores() throws java.rmi.RemoteException, com.geored.negocio.DaoException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://negocio.geored.com/", "obtenerListadoTiposAdministradores"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (com.geored.negocio.TipoAdministradorDTO[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.geored.negocio.TipoAdministradorDTO[]) org.apache.axis.utils.JavaUtils.convert(_resp, com.geored.negocio.TipoAdministradorDTO[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
  ...
  throw axisFaultException;
    ...
    public com.geored.negocio.TipoNotificacionDTO[] obtenerListadoTiposNotificaciones() throws java.rmi.RemoteException, com.geored.negocio.DaoException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://negocio.geored.com/", "obtenerListadoTiposNotificaciones"));
