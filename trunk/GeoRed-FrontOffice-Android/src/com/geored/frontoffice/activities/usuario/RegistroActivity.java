...
public class RegistroActivity extends Activity
{
	...
	public void registroUsuario(View v) throws IOException, XmlPullParserException
	{
		...
		EditText urlImagen = (EditText) this.findViewById(R.id.txtUrlImagen);// PARA
																				// PASAR
																				// LA
																				// URL
		...
		// en el boton "continuar registro" mandarlo para el activity de
		// tematicas
		// pasar a la activity de tematicas el usuarioDTO (pre cargado)
		// ,cergarle las tematicas que seleccione
		// insertar al nuevo usuario, si todo ok por ultimo retornar al menu del
		// usuario
